...
`최적화_문제해결사` `원팀플레이어` <br />
**느린 렌더링, 사용하기 불편한 UX 등 서비스를 이용할 때 방해되는 요소를 찾아내고 개선하는 데 집중합니다. <br />
서비스의 품질뿐만 아니라 개발자가 효율적으로 개발하기 위한 환경을 함께 고민합니다.**

- On-Premise 사이버보안 검증 툴 개발 및 유지보수, 고객사 사이버보안 검증 프로젝트에서 활용 중
- 한 해에 약 4000명이 참가하는 기업 전문가 연계 ICT공모전에서 **금상·동상** 수상, **프로그램 저작권 등록(C-2024-047133)** 및 ACK 추계학술대회 논문 2편 게재
...
- (2026.1 ~) 슈어소프트테크 모빌리티솔루션실 전임연구원
  - ISO/SAE 21434, ISO 26262에 따른 차종 사이버보안 검증 프로젝트 수행
    [VCMS 제어기 전력변환 SW 배포 검증] (2026.2 ~)
    - 차종/지역향별 SW 배포 검증: ECUID 진단 검증, 유무선 업데이트 평가, BMS/PCU/VCU/MCU/OBC 고장 진단 및 진단 검증
    - 검증 환경: CaNoe 17, H-OTA, VCMS 테스트 보드

    [OPU 제어기 차종 사이버보안 평가] (2026.2 ~ 2026.2)
    - HSM 기능 사양 평가: 검증 환경 구축 후 NIST 테스트 벡터 기반 테스트 코드 작성, 암/복호화 알고리즘 기능 검증 수행
    - 검증 환경: TRACE32, 모빌진, Power Supply

    [DHS 제어기 3종 차종 사이버보안 평가] (2026.1 ~ 2026.2)
    - SW 오픈소스 보안 평가: SW 오픈소스 보안 검증 툴을 활용해 ES10500-00 표준 기반 오픈소스 취약점 및 라이선스 검증 수행
    - 제어기 SW 리프로그래밍 평가: 펌웨어 리프로그래밍 시 사용되는 암/복호화 알고리즘 기능 신뢰성 검증, SecureFlash 기반 펌웨어 규격, 무결성 검증 및 암호화 키 생성 기능 사양 검증
    - 제어기 일반보안사양 검증: ES95489-21 표준 기반 제어기 통신 및 칩셋 사양을 분석, HW/SW 보안 요구사항 준수 여부 검증
    - 검증 환경: IAR, CaNoe 17, H-OTA, Power Supply

    [사이버보안 검증 자동화 도구 개발] (2026.1 ~ 2026.2)
    - 사이버보안 검증 도구 On-premise AI 서비스 개발 및 유지보수

      
- (2025.9 ~ 2025.12) 슈어소프트테크 모빌리티솔루션실 인턴(Fullstack Engineer)
  - 고객사 사이버보안 검증 프로젝트에서 활용되는 검증 자동화 도구 개발 및 운영
  - 풀스택(ReactJS 18, Flask) 개발: 오픈 AI 모델 사용 및 사이버보안 검증 자동화 도구 개발 및 유지보수
  - Qwen QWQ 32B 모델 SFT 및 DPO Fine-Tuning 수행 (On-premise AI 서비스 개발 목적)
